...
void Instruction :: uintToBinarylist<unsigned int> list){
...
// The other option of of not having a menu is to simply write these outputs in the main() section(?)
void Memory::menu(Memory obj)
{
  string response;
  int parameter;
  ...
  cin >> response;
  obj.read_csv(response);

  // not coded yet
  cout << endl << "Thank you. Processing..." << endl;
  cout << "Enter perameter for program: ";
  cin >> parameter;
}
