...
class Memory; //youtube.com/watch?v=oHg5SJYRHA0 <--- very useful, I highly recommend watching this
class Instruction;
class Pipeline;
class IQueue;
class Execute;
...
void Pipeline :: select_file()
{
  ...
  try
  {
    ...
    else if (user_choice == "Funtimes" || user_choice == "Funtimes.csv")
    {
      funtimes();
    }
